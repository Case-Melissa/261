...
<html lang ="en-us">
    <head>
        <meta charset="UTF-8">
        <title>Home | Budgetdesigning.com</title>
        <meta name="Author" content="Melissa Case">
    ...
    <body id="home">
        ...
        <main>
            <div>
                <h1 id="Home">Home</h1>
                <p>Welcome to my site. Please click on the page for a working sample of my code.</p>   
            </div>
            <div>
